...
import { Sparkles, ArrowLeft, TrendingUp, TrendingDown, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex bg-[#0A0F1A] text-[#ECEEF0]">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 py-8 pb-24">
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-2 text-xs font-mono text-[#8A93A6] hover:text-[#ECEEF0] mb-6 transition-colors"
        >
